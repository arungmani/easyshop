						...
						<div class="card-header">
							...
							<p align="right">
								...
								<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									...
									<form method="POST" action="{{url('variant_type_insert')}}" enctype="multipart/form-data">@csrf
										...
										<div class="modal-dialog" role="document" style="width:80%;">
											...
											<div class="modal-content">
												...
												<div class="modal-header">
													...
													<h5 class="modal-title" id="exampleModalLabel">Add Variant Types</h5>
								...
								<tbody>@php $i=1; @endphp @foreach($vari as $key)
									...
									<tr>
										...
										{{$key->varient_type}}
                                     	...
                                     	<td> <i class="fa fa-edit edit_variant" aria-hidden="true" data-toggle="modal" data-id="{{$key->id}}">
										 </i>
										 
										 <a href="{{url('DeleteVariantType')}}/{{ $key->id }}" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="fa fa-trash delvar"></i></a>
							...
							<div class="modal" id="editvariant_modal" tabindex="-1" role="dialog">
								...
								<div class="modal-dialog" role="document">
									...
									<div class="modal-content">
										...
										<form method="POST" action="{{url('variant_type_edit')}}" enctype="multipart/form-data">@csrf

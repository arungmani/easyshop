                   ...
                   <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-info-area">
                            <div class="footer-logo">
                                <a href="#"><img src="{{asset('web/assets/images/logo/1.svg')}}" alt="" style="height: 60px"></a>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-7">
                        <div class="copy-right">
                            <p>Copyright 2018 <a href="#">eeezyshop</a>. All Rights Reserved</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-5">
                        <div class="payment">
                            <img src="{{asset('web/assets/images/icon/1.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
